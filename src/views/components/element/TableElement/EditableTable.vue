  ...
  return [
    {
      text: '열 삽입',
      children: [
        { text: '왼쪽에 삽입', handler: () => insertCol(colIndex) },
        { text: '오른쪽에 삽입', handler: () => insertCol(colIndex + 1) },
      ],
    },
    {
      text: '행 삽입',
      children: [
        { text: '위에 삽입', handler: () => insertRow(rowIndex) },
        { text: '아래에 삽입', handler: () => insertRow(rowIndex + 1) },
      ],
    },
    {
      text: '열 삭제',
