<template>
  <div class="slide-toolbar">
    <div class="remark">
      <textarea
        :value="remark"
        placeholder="클릭하여 발표자 노트를 입력하세요"
