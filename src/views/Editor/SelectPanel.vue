<template>
  <MoveablePanel 
    ...
    :width="200" 
    :height="360" 
    :title="`선택 (${activeElementIdList.length}/${currentSlide.elements.length})`" 
    :left="-270" 
    :top="90"
    @close="close()"
  >
    <div class="handler" v-if="elements.length">
      <div class="btns">
        <Button size="small" style="margin-right: 5px;" @click="showAllElements()">모두 표시</Button>
        <Button size="small" @click="hideAllElements()">모두 숨기기</Button>
      </div>
