<template>
  <div class="slide-design-panel">
    ...
    <div class="row">
      <Select 
        ...
        :options="[
          ...
          { label: '이미지 채우기', value: 'image' },
          { label: '그라데이션 채우기', value: 'gradient' },
        ]"
      />
      ...
      <Select 
        ...
        :options="[
          { label: '축소', value: 'contain' },
          { label: '타일', value: 'repeat' },
          { label: '확대 채우기', value: 'cover' },
        ]"
      />
      ...
      <Select 
        ...
        v-else
        :options="[
          { label: '선형 그라데이션', value: 'linear' },
          { label: '원형 그라데이션', value: 'radial' },
        ]"
      />
    </div>
    ...
    <div class="row">
      <Button style="flex: 1;" @click="applyBackgroundAllSlide()">전체 슬라이드에 배경 적용</Button>
    </div>
    ...
    <div class="row">
      <Select 
        ...
        :options="[
          ...
          { label: '용지 A3 / A4', value: 0.70710678 },
    ...
    <div class="row">
      <Button style="flex: 1;" @click="applyThemeToAllSlides(moreThemeConfigsVisible)">전체 슬라이드에 테마 적용</Button>
    </div>

    <div class="row">
      <Button style="flex: 1;" @click="themeStylesExtractVisible = true">슬라이드에서 테마 추출</Button>
    </div>

    <Divider />

    <div class="title">프리셋 테마</div>
    <div class="theme-list">
      ...
      >
        <div class="theme-item-content">
          <div class="text" :style="{ color: item.fontColor }">글자 Aa</div>
          <div class="colors">
            <div class="color-block" v-for="(color, index) in item.colors" :key="index" :style="{ backgroundColor: color }"></div>
          </div>

          <div class="btns">
            <Button type="primary" size="small" @click="applyPresetTheme(item)">적용</Button>
            <Button type="primary" size="small" style="margin-top: 3px;" @click="applyPresetTheme(item, true)">전체 적용</Button>
          </div>
        </div>
      </div>
    </div>
