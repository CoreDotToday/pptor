...
const elementTabs = computed<ElementTabs[]>(() => {
  if (handleElement.value?.type === 'text') {
    return [
      { label: '스타일', key: ToolbarStates.EL_STYLE },
      { label: '기호', key: ToolbarStates.SYMBOL },
      { label: '위치', key: ToolbarStates.EL_POSITION },
      { label: '애니메이션', key: ToolbarStates.EL_ANIMATION },
    ]
  }
  return [
    { label: '스타일', key: ToolbarStates.EL_STYLE },
...
const slideTabs = [
  { label: '디자인', key: ToolbarStates.SLIDE_DESIGN },
  { label: '전환 효과', key: ToolbarStates.SLIDE_ANIMATION },
  { label: '애니메이션', key: ToolbarStates.EL_ANIMATION },
]

const multiSelectTabs = [
  { label: '스타일 (다중 선택)', key: ToolbarStates.MULTI_STYLE },
  { label: '위치 (다중 선택)', key: ToolbarStates.MULTI_POSITION },
]
