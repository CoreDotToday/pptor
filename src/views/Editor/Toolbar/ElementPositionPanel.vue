<template>
  <div class="element-positopn-panel">
    ...
    <ButtonGroup class="row">
      <Button style="flex: 1;" v-tooltip="'왼쪽 정렬'" @click="alignElementToCanvas(ElementAlignCommands.LEFT)">
        <IconAlignLeft />
      </Button>
      <Button style="flex: 1;" v-tooltip="'가로 가운데 정렬'" @click="alignElementToCanvas(ElementAlignCommands.HORIZONTAL)">
        <IconAlignVertically />
      </Button>
      <Button style="flex: 1;" v-tooltip="'오른쪽 정렬'" @click="alignElementToCanvas(ElementAlignCommands.RIGHT)">
        <IconAlignRight />
      </Button>
    </ButtonGroup>
    <ButtonGroup class="row">
      <Button style="flex: 1;" v-tooltip="'위쪽 정렬'" @click="alignElementToCanvas(ElementAlignCommands.TOP)">
        <IconAlignTop />
      </Button>
      <Button style="flex: 1;" v-tooltip="'세로 가운데 정렬'" @click="alignElementToCanvas(ElementAlignCommands.VERTICAL)">
        <IconAlignHorizontally />
      </Button>
      <Button style="flex: 1;" v-tooltip="'아래쪽 정렬'" @click="alignElementToCanvas(ElementAlignCommands.BOTTOM)">
        <IconAlignBottom />
      </Button>
    </ButtonGroup>
