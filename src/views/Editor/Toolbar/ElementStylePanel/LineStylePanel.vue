<template>
  <div class="line-style-panel">
    ...
    <div class="row">
      <div style="width: 40%;">시작점 스타일:</div>
      <SelectCustom style="width: 60%;">
        <template #options>
    ...
    <div class="row">
      <Button style="flex: 1;" @click="updateLine({ start: handleLineElement.end, end: handleLineElement.start })">
        <IconSwitch /> 방향 바꾸기
      </Button>
    </div>
